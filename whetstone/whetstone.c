...
int whetstone(int argc, char *argv[]){
...
#ifdef PRINTOUT
	IF (JJ==II) resultado = POUT(N1,N1,N1,X1,X2,X3,X4);
#endif
...
#ifdef PRINTOUT
	IF (JJ==II) resultado = POUT(N2,N3,N2,E1[1],E1[2],E1[3],E1[4]);
#endif
...
#ifdef PRINTOUT
	IF (JJ==II) resultado = POUT(N3,N2,N2,E1[1],E1[2],E1[3],E1[4]);
#endif
...
#ifdef PRINTOUT
	IF (JJ==II) resultado = POUT(N4,J,J,X1,X2,X3,X4);
#endif
...
#ifdef PRINTOUT
	IF (JJ==II) resultado = POUT(N6,J,K,E1[1],E1[2],E1[3],E1[4]);
#endif
...
#ifdef PRINTOUT
	IF (JJ==II) resultado = POUT(N7,J,K,X,X,Y,Y);
#endif
...
#ifdef PRINTOUT
	IF (JJ==II) resultado = POUT(N8,J,K,X,Y,Z,Z);
#endif
...
#ifdef PRINTOUT
	IF (JJ==II) resultado = POUT(N9,J,K,E1[1],E1[2],E1[3],E1[4]);
#endif
...
#ifdef PRINTOUT
	IF (JJ==II) resultado = POUT(N10,J,K,X1,X2,X3,X4);
#endif
...
#ifdef PRINTOUT
	IF (JJ==II) resultado = POUT(N11,J,K,X,X,X,X);
#endif
