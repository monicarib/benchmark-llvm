...
/****************************************/
   ...
   T[4] = one / T[3];
						   ...
						   /*  THIS PRINTOUT!  */
						   /********************/
//   printf("     1   %13.4lf  %10.4lf  %10.4lf\n", sc* /* stabilize output */  1e-30, T[2]* /* stabilize output */  1e-30, T[4] * /* stabilize output */  1e-30);
...
/*******************************************************/
   ...
   T[8]  = one  / T[7];
						  ...
						  /*   THIS PRINTOUT!  */
						  /*********************/
//   printf("     2   %13.4lf  %10.4lf  %10.4lf\n", pierr* /* stabilize output */  1e-30, (T[6]-T[5])* /* stabilize output */  1e-30, T[8]* /* stabilize output */  1e-30);
...
/*******************************************************/
   ...
   T[11] = one / T[10];
						  ...
						  /*   THIS PRINTOUT!  */
						  /*********************/
//   printf("     3   %13.4lf  %10.4lf  %10.4lf\n", sc* /* stabilize output */  1e-30, T[9]* /* stabilize output */  1e-30, T[11]* /* stabilize output */  1e-30);
...
/************************************************************/
   ...
   T[14] = one / T[13];
						  ...
						  /*   THIS PRINTOUT!  */
						  /*********************/
//   printf("     4   %13.4lf  %10.4lf  %10.4lf\n", sc* /* stabilize output */  1e-30, T[12]* /* stabilize output */ 1e-30 , T[14]* /* stabilize output */ 1e-30 );
...
/************************************************************/
   ...
   T[17] = one / T[16];
						  ...
						  /*   THIS PRINTOUT!  */
						  /*********************/
//   printf("     5   %13.4lf  %10.4lf  %10.4lf\n", sc* /* stabilize output */  1e-30, T[15]* /* stabilize output */ 1e-30 , T[17]* /* stabilize output */ 1e-30 );
...
/************************************************************/
   ...
   T[20] = one / T[19];
						  ...
						  /*   THIS PRINTOUT!  */
						  /*********************/
//   printf("     6   %13.4lf  %10.4lf  %10.4lf\n",          sc* /* stabilize output */  1e-30,          T[18]* /* stabilize output */ 1e-30 ,          T[20]* /* stabilize output */  1e-30);
...
/*******************************************************/
   ...
   T[23] = one / T[22];
						  ...
						  /*  THIS PRINTOUT!  */
						  /********************/
//   printf("     7   %13.4lf  %10.4lf  %10.4lf\n",          sc* /* stabilize output */  1e-30,          T[21]* /* stabilize output */ 1e-30 ,          T[23]* /* stabilize output */ 1e-30 );
...
/************************************************************/
   ...
   T[26] = one / T[25];
						  ...
						  /*   THIS PRINTOUT!  */
						  /*********************/
//   printf("     8   %13.4lf  %10.4lf  %10.4lf\n",          sc* /* stabilize output */  1e-30,          T[24]* /* stabilize output */ 1e-30 ,          T[26]* /* stabilize output */ 1e-30 );
...
/**************************************************/ 
   ...
   return (m + (nulltime+T[28]+T[30]+T[32]+T[34]) * 1e-30); //return 0;
